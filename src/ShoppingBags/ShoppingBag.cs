...
internal class USSBagInventory : MonoBehaviour
{
    ...
    private static readonly Type ModShopBagInvType = ModLoader.CurrentGame == Game.MySummerCar && ESPresent ? Type.GetType("ExpandedShop.ModShopBagInv, ExpandedShop") : null;
    ...
    private IEnumerator InitiateBag()
    {
        ...
        if (ModLoader.CurrentGame == Game.MySummerCar && ESPresent) TakeESOver();
