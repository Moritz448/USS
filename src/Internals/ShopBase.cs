...
public abstract class ShopBase : MonoBehaviour
{
    ...
    internal ItemShopRaycast itemShopRaycast;
    ...
    protected virtual void Start()
    {
        ...
        itemShopRaycast = player.GetComponent<ItemShopRaycast>() ?? player.AddComponent<ItemShopRaycast>();
    ...
    {
        ModConsole.Log($"\n[USS] Debug info for shop {this.ShopID}");
        ModConsole.Log($"Item name: {ItemName}\nItem prefab: {ItemPrefab}\n");
        ModConsole.Log($"Stock: {Stock}");
    }
#endif
}
